                ...
                <form action="{{route('animal.update',$animal)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select name="diet" class="custom-select" >
                            <option @if ($animal->diet == "Carnivore") selected @endif value="Carnivore">Carnivore</option>
                            <option @if ($animal->diet == "Herbivore") selected @endif value="Herbivore" >Herbivore</option>
                            <option @if ($animal->diet == "Omnivore")  selected @endif value="Omnivore">Omnivore</option>
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="arrival_date" value="{{$animal->arrival_date}}" required>
                    </div>
                    <div class="form-group">
