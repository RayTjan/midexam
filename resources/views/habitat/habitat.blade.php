...
<div class="headFlag">
    ...
    <div class="container-fluid" style="margin-top: 20px;">
        <div class="row">
            ...
            <div class="col-md-2">
            <a  href="{{route('habitat.create')}}" class="btn btn-block nunito greenButton" role="button" aria-pressed="true">Add Habitat</a>
            </div>
        </div>
            ...
            <table class="table table-striped adminTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="{{route('habitat.edit',$habitat)}}"><button type="submit" class="btn btn-primary">Edit</button></a></td>
                    
                        <td><form action="{{route('habitat.destroy',$habitat)}}" method="post">
                            {{csrf_field()}} 
                            {{-- orr @csrf --}}
